...
public class HugLife {
     ...
     * After all cycles have finished, or on exit, these images are combined into an
     * animated GIF.
     * Requires ImageMagick and only works in SIMULATE_BY_CYCLE mode.
     * Consider reducing PAUSE_TIME_PER_SIMSTEP when this flag is on, since file
     * writes will take some time.
     * See the HugLifeAnimator class for details.
     */
    public static final boolean GENERATE_GIF = false;

    /**
     * Name of output GIF (relative to working directory), assuming GENERATE_GIF is
     * true.
     * Should end in ".gif".
     */
